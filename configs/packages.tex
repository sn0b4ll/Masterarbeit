...
\definecolor{AllianzBlue}{rgb}{0.07,0.20,0.53}
%%-------------Allgemeine Definitionen----------------------------------
% Farbige Aufwertung der berschriften
\addtokomafont{chapter}{\color{AllianzBlue}}
\addtokomafont{section}{\color{AllianzBlue}}
\addtokomafont{caption}{\color{AllianzBlue}}
\addtokomafont{subsection}{\color{AllianzBlue}}
\addtokomafont{subsubsection}{\color{AllianzBlue}}
\setkomafont{captionlabel}{\color{AllianzBlue}}
...
%URL-Umgebung
\usepackage{url}
\renewcommand{\UrlFont}{\small\color{THIblue}}
